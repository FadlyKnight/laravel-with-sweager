                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        {{-- <div class="text-center">
                            <a href="index.html" class="logo">
                                <img src="{{ asset('dashboard/assets/images/logo-light.png') }}" alt="" height="22" class="logo-light mx-auto">
                               <img src="{{ asset('dashboard/assets/images/logo-dark.png') }}" alt="" height="22" class="logo-dark mx-auto">
                            </a>
